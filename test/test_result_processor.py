...
def test_valid_result_fields(
    create_database_if_not_existing_mock, test_connection_mock, get_resultfilds_names_mock, existing_result_fields, used_result_fields, subset_boolean
):
    create_database_if_not_existing_mock.return_value = None
    test_connection_mock.return_value = None
    ...
    assert subset_boolean == ResultProcessor(mock_config, False, None, CREDENTIAL_PATH, "test_table_name", 0, logger)._valid_result_fields(
