...
def test_tables_created(
    execute_mock, close_connection_mock, fetchall_mock, cursor_mock, connect_mock, fill_table_mock, test_connection_mock, create_database_mock
):
    ...
    assert execute_mock.mock_calls[2][1][1] == (
        "CREATE TABLE test_mysql_logtables__test_mysql_log (ID INTEGER PRIMARY KEY AUTO_INCREMENT,"
...
def test_logtable_insertion(database_connector_mock):
    ...
    result_processor.process_logs({"test_mysql_log": table_0_logs, "test_mysql_log2": table_1_logs})
...
def test_delete_logtable(
    execution_mock, close_connection_mock, commit_mocck, fetchall_mock, cursor_mock, connect_mock, test_connection_mock, create_database_mock
):
    ...
    execution_mock.assert_has_calls(
        [
            call(None, "DROP TABLE IF EXISTS test_mysql_logtables__test_mysql_log"),
