...
def test_create_table_if_not_exists(
    ...
    cursor_mock,
    table_exists_mock,
    table_has_correct_structure_mock,
):
    ...
    create_table_string = (
        "CREATE TABLE test_table (ID INTEGER PRIMARY KEY AUTO_INCREMENT, value int DEFAULT NULL,exponent int DEFAULT NULL,"
    ...
    execute_mock.assert_has_calls([mock.call(None, "SHOW TABLES LIKE 'test_table'"), mock.call(None, create_table_string)])
