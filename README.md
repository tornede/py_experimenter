<img src="docs/py-experimenter-logo.png" alt="PyExperimenter Logo: Python biting a database" width="200px"/>
...
![General schema of `PyExperimenter`.](paper/usage.png)

## Installation

The `PyExperimenter` module can be easily installed via PyPI, installing the needed [requirements](requirements.txt) at the same time.
...
2. Define the [experiment function](#defining-the-experiment-function), computing the experiment result based on the input parameters.
3. [Execute the experiments](#executing-the-pyexperimenter), writing the results into the database table.
4. Finally, the results of different experiment configurations can be viewed in the database table, or [extracted to a LaTeX table](#obtain-results).
