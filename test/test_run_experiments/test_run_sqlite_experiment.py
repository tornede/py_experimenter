...
def test_run_all_sqlite_experiments():
    ...
    experimenter = PyExperimenter(
        experiment_configuration_file_path=os.path.join("test", "test_run_experiments", "test_run_sqlite_experiment_config.cfg"), use_codecarbon=False
    )
    try:
...
def test_raising_error_experiment():
    experimenter = PyExperimenter(
        experiment_configuration_file_path=os.path.join("test", "test_run_experiments", "test_run_sqlite_error_config.cfg"),
        name="name",
