...
experimenter = PyExperimenter(config_path=os.path.join('examples', 'example_reset_experiments.cfg'),
                              experimenter_name='Experimenter before reset')
...
experimenter = PyExperimenter(config_path=os.path.join('examples', 'example_reset_experiments.cfg'),
                              experimenter_name='Experimenter after reset')
